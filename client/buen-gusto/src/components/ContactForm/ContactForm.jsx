...
const ContactForm = () => {
  ...
  return (
    <div className={`container-fluid p-5 ${style.container}`} id="contacto">
      <div className='row row-eq-height'>  
        ...
        <div className='col-lg-4 col-md-12 md-mt-3'>
            ...
            <ul className="list-unstyled mt-4">
              <li className="mb-4">
                  <a class="link-light link-underline-opacity-0" href="#"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
