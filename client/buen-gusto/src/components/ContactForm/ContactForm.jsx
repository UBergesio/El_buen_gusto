      ...
      <div className={`row row-eq-height ${style.color}`}>  
        ...
        <div className='col-lg-7 col-md-12'>
          ...
          <form ref={form} onSubmit={sendEmail} className="row g-1">
            ...
            <div className="col-md-6">
              <input type="text" className={`form-control shadow-none ${style.inputborder}`} id="lugar" placeholder="Lugar" name="place" />
            </div>

            <div className="input-group md-3"> 
              <label class="input-group-text bg-transparent text-light" for="fecha">Fecha aproximada del evento</label>
            ...
            <button type="submit" className={`btn btn-danger ${style.customButton}`}>Contactar</button>
          </form>
        </div>
        ...
        <div className='col-lg-4 col-md-12 md-mt-3'>
            ...
            <ul className="list-unstyled mt-4">
              ...
              <li className="mb-4">
                  <a class="link-light link-underline-opacity-0" href="https://instagram.com/catering_elbuengusto"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg> catering_elbuengusto
                </a>
              </li>
              <li className="mb-4">
                  <a class="link-light link-underline-opacity-0" href="https://www.facebook.com/profile.php?id=100063906111468"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M16.7002 15.6672L17.3736 12H13.4539V10.703C13.4539 8.76528 14.2142 8.01984 16.1818 8.01984C16.7928 8.01984 17.2848 8.03472 17.568 8.06448V4.74048C17.0314 4.5912 15.7195 4.4424 14.9592 4.4424C10.9493 4.4424 9.1008 6.33552 9.1008 10.4198V12H6.6264V15.6672H9.1008V23.6467C10.0291 23.8771 11.0002 24 11.9995 24C12.4915 24 12.9768 23.9698 13.4534 23.9122V15.6672H16.6997H16.7002Z" fill="none"/>
                    </g>
                    <defs>
