    ...
    >
      <div className="row">
        <div className={`col-md-6 mb-3 ${style.parrafos}`}>
          ...
          momento sea mágico y memorable. <br /><br /> Trabajamos incansablemente para
          ofrecerte soluciones en todos los aspectos de tu celebración. Contamos
          con un equipo de profesionales excepcionales.
        </div>
