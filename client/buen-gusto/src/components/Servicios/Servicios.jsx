...
const Servicios = () => {
  return (
    <div className={`container-fluid text-center  ${style.container}`}>
      <div className="row align-items-start">
        <div className="col-lg-4 col-12 p-4">
          ...
          <p>
            ...
            aún más inolvidable con nuestro servicio de catering exclusivo para
            bodas. En "El Buen Gusto", entendemos que cada boda es única, y nos
            comprometemos a ofrecerte un servicio personalizado que refleje tu
            estilo y creé recuerdos que perdurarán toda la vida.
          </p>
        </div>
